...
exports.getMin = exports.getMax = exports.buildWhere = exports.batchLoad = void 0;
...
function buildWhere(loadKeys) {
    ...
    where["OR"] = loadKeys.map(function (loadKey) { return (0, lodash_es_1.omit)(loadKey, singleKeys); });
    return where;
}
exports.buildWhere = buildWhere;
function getMin(array) {
    return array.reduce(function (acc, value) {
        return (0, lodash_es_1.isNil)(value) ? acc : (0, lodash_es_1.isNil)(acc) ? value : acc < value ? acc : value;
    }, null);
}
